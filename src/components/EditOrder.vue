      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="trackNumber" v-model="order.trackNumber" readonly>
          </div>
          <div class="form-group mb-3">
...
const orders = ref([
  ...
  { date: '07/26/2024', customerName: 'Jane Smith', deliveryAddress: '456 Oak St', trackNumber: 'TN002', status: 'Delivered', details: [{ product: 'Item B', quantity: 1, price: 25.00 }] }
]);
...
const saveOrder = () => {
  if (isValidOrder.value) {
    ...
    // You can make an API call here to save the order
    router.push('/OrderList');
  } else {
